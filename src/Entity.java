 ...
 */
 ...
 public abstract class Entity {
    ...
    public String fiName; // file name of the object
     ...
     */
     ...
     public void changeSprite(String x) {
    	 sprite = (SpriteStore.get()).getSprite(x);
     }
     ...
     */
      ...
      */
      ...
      public boolean closeBy(Entity other) {
          me.setBounds((int)x -50, (int)y -50, sprite.getWidth() + 100, sprite.getHeight() + 100);
          him.setBounds(other.getX() -50, other.getY() -50, 
                        other.sprite.getWidth() + 100, other.sprite.getHeight() + 100);
          return me.intersects(him);
        } // collidesWith
